      ...
      <header className="space-y-4">
        ...
        <div className="relative aspect-[16/9] w-full overflow-hidden rounded-2xl border border-border bg-[url('/images/placeholder.svg')] bg-cover bg-center">
          <Image
            ...
            alt=""
            fill
            className="object-cover opacity-100 transition-opacity md:transition-transform duration-200 ease-out motion-reduce:transition-none hover:opacity-95 md:hover:scale-[1.01] will-change-transform [animation:none]"
            priority
          />
        </div>
      </header>
