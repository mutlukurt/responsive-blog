      ...
      <Link href={`/blog/${post.slug}`} className="block">
        <div className="relative aspect-[16/9] overflow-hidden bg-[url('/images/placeholder.svg')] bg-cover bg-center">
          <Image
            ...
            alt=""
            fill
            className="object-cover transform-gpu opacity-100 transition-opacity transition-transform duration-300 ease-out motion-reduce:transition-none group-hover:opacity-90 active:opacity-90 focus-visible:opacity-90 group-hover:scale-[1.02] active:scale-[1.01] focus-visible:scale-[1.01] will-change-transform [backface-visibility:hidden] [transform:translateZ(0)] [animation:none]"
